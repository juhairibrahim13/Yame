...
import { 
  ...
  BookOpen, Compass, Shield, Users, Plus
} from 'lucide-react';
      ...
      <div className="flex justify-center gap-4 border-b border-white/5 pb-4">
        <button
          ...
          className={cn(
            ...
            activeTab === 'scenarios' ? "bg-teal-500 text-white shadow-lg shadow-teal-500/20" : "bg-white/5 text-slate-400 hover:bg-white/10"
          )}
        >
        ...
        <button
          ...
          className={cn(
            "flex items-center gap-2 px-6 py-3 rounded-xl font-bold transition-all",
            activeTab === 'reports' ? "bg-teal-500 text-white shadow-lg shadow-teal-500/20" : "bg-white/5 text-slate-400 hover:bg-white/10"
          )}
        >
      ...
      {activeTab === 'reports' && (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-8">
          <div className="flex justify-between items-center">
            ...
            <button className="flex items-center gap-2 px-4 py-2 rounded-xl bg-teal-500/10 text-teal-400 hover:bg-teal-500/20 transition-colors font-bold text-sm">
              ...
              <div key={report.id} className="glass-card p-6 space-y-4">
                <div className="flex justify-between items-start">
                  <div className="space-y-1">
                    ...
                    <div className="inline-block px-2 py-0.5 rounded bg-teal-500/10 text-teal-400 text-[10px] font-bold uppercase tracking-widest">
                      Target: {report.type}
                    </div>
                  </div>
                  <div className="flex items-center gap-1 text-slate-400 bg-white/5 px-3 py-1 rounded-full text-sm">
                ...
                <div className="space-y-4 pt-4 border-t border-white/5">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-teal-400/90 text-sm leading-relaxed italic">{report.result}</p>
                  </div>
                </div>
              </div>
            ))}
